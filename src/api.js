...
export const setAdminStartingBalance = (adminUsername, { cashAmount, bitAmount, payboxAmount, otherAmount, notes }) =>
  api.post('/wallets/starting-balance', { adminUsername, cashAmount, bitAmount, payboxAmount, otherAmount, notes });
